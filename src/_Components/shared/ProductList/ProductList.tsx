...
export default function ProductList({ products }: { products: IProduct[] }) {
    ...
    return (
        <div className="grid grid-cols-4 ">
            <button onClick={() => setIsOpenFilter(!isOpenFilter)} className={` fixed ${isOpenFilter ? 'rotate-270' : ''} rotate-90  left-0 sm:flex bg-text2 text-primary items-center px-2 py-1 rounded-t-md  border-b-0 active:scale-105 hidden`}>
